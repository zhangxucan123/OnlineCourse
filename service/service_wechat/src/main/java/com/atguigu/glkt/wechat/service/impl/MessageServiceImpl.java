...
import com.atguigu.glkt.wechat.service.MessageService;
...
public class MessageServiceImpl implements MessageService {
    ...
    public void pushPayMessage(long orderId) {
        String openid = "osuD86leV1jblwvEZaDJtoSONKUw";
        WxMpTemplateMessage templateMessage = WxMpTemplateMessage.builder()
                .toUser(openid)//要推送的用户openid
                .templateId("VF_RlPDMA2kEYmQi0PI--Y4uXL4THZCj3NSLXBhrnYY")//模板id
                .url("http://zxc.vipgz4.91tunnel.com/#/pay/"+orderId)//点击模板消息要访问的网址
                .build();
    ...
    private String aboutUs(Map<String, String> param) {
        StringBuffer msg = this.text(param, "\"硅谷课堂现开设Java、HTML5前端+全栈、大数据、全链路UI/UE设计、人工智能、" +
                "大数据运维+Python自动化、Android+HTML5混合开发等多门课程；" +
                "同时，通过视频分享、谷粒学苑在线课堂、大厂学苑直播课堂等多种方式，" +
                "满足了全国编程爱好者对多样化学习场景的需求，已经为行业输送了大量IT技术人才。\"");
        return msg.toString();
    }
    ...
    private String search(Map<String, String> param) {
        ...
        if(CollectionUtils.isEmpty(courseList)) {
            ...
            articles.append("<Url><![CDATA[http://zxc.vipgz4.91tunnel.com/#/liveInfo/"+course.getId()+"]]></Url>");
            articles.append("</item>");
