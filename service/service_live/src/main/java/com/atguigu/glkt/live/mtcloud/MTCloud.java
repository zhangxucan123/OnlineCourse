...
package com.atguigu.glkt.live.mtcloud;


import com.atguigu.glkt.live.mtcloud.utils.MD5Util;
...
public class MTCloud {	    
	     ...
	     * 合作方ID： 合作方在欢拓平台的唯一ID
	     */
	    public String openID = "55301";
	    
	    /**
	     * 合作方秘钥： 合作方ID对应的参数加密秘钥
	     */
	    public String openToken = "cd044598b333bb439949229fcf6f1fcc";
